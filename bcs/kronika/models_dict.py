...
from .models import (
    Kadencja, PodsumowanieKadencji,
    TypWydarzeniaHistorycznego, WydarzenieHistoryczne,
...
add_model_name(KategoriaZadaniaChrzcielnego, names, "KategoriaZadaniaChrzcielnego")
