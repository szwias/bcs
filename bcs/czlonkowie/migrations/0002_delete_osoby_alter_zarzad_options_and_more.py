...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            name='zarzad',
            options={'ordering': ['-kadencja'], 'verbose_name': 'Zarząd', 'verbose_name_plural': 'Zarządy'},
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='bractwo',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='czlonkowie_bractwa', to='encyklopedia.bractwo', verbose_name='Bractwo'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='zarzad',
            name='kadencja',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.kadencja', verbose_name='Kadencja'),
        ),
        migrations.AddField(
            model_name='zarzad',
            name='kasztelan',
